...
(function () {
  ...
  const I18N = {
    en: {
      ...
      beta_label: "Beta testers wanted",
      beta_title: "Help us test EnerFlow on Android",
      beta_lead:
        "Join the tester group first, then install the closed testing build from Google Play.",
      beta_join: "Join the tester group",
      beta_download: "Download Android beta",
    ...
    it: {
      ...
      beta_label: "Cercasi beta tester",
      beta_title: "Aiutaci a provare EnerFlow su Android",
      beta_lead:
        "Iscriviti prima al gruppo tester, poi installa la build di closed testing da Google Play.",
      beta_join: "Iscriviti al gruppo tester",
      beta_download: "Scarica la beta Android",
